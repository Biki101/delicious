...
export default function Testimonials() {
  return (
    <div className="h-[550px] w-full relative mt-[100px]">
      <Image
        src={testimonial}
        height={550}
        width={1280}
      ...
      />
      <div className="flex flex-col justify-center items-center h-[550px] gap-[12px] z-[2]">
        <div className="text-[#b49383] font-bold text-[25px] cursive-font">
          What They Say
        </div>
        ...
        <div className="text-[13px] text-[var(--placeholder-color)] w-[500px] text-center">
